...
SYSTEM_PROMPT = """You are a deep research assistant. Your task is to help the user find accurate answers by searching a local knowledge base and visiting relevant pages.
